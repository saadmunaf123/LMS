      ...
      <div className="flex flex-col gap-3 lg:hidden">
        ...
        <div className="flex flex-wrap items-center gap-3 bg-white dark:bg-slate-900 p-3 rounded-lg shadow-md">
          ...
          <button
            ...
            className="flex items-center gap-1 bg-orange-500 dark:bg-orange-500 text-white px-4 py-2 rounded-lg shadow hover:bg-orange-600 dark:hover:bg-orange-500 transition"
          >
