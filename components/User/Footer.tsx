      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between gap-8">
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="/contactus" className="hover:text-orange-600 transition">Contact</a></li>
          </ul>
        </div>
        ...
        <div className="flex-1">
          ...
          <form className="flex gap-2">
            <input 
              ...
              className="flex-grow p-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-orange-500 outline-none text-sm"
            />
